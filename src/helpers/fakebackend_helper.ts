...
export const deleteCategory = (data: any) =>
  api.delete(url.DELETE_CATEGORY, { headers: { data } });
...
export const deleteOrders = (data: any) =>
  api.delete(url.DELETE_ORDERS, { headers: { data } });
...
export const addProductList = (data: any) =>
  api.create(url.ADD_PRODUCT_LIST, data);
export const updateProductList = (data: any) =>
  api.update(url.UPDATE_PRODUCT_LIST, data);
export const deleteProductList = (data: any) =>
  api.delete(url.DELETE_PRODUCT_LIST, { headers: { data } });

// Grid View
export const getProductGrid = () => api.get(url.GET_PRODUCT_GRID, null);
export const addProductGrid = (data: any) =>
  api.create(url.ADD_PRODUCT_GRID, data);
export const updateProductGrid = (data: any) =>
  api.update(url.UPDATE_PRODUCT_GRID, data);
export const deleteProductGrid = (data: any) =>
  api.delete(url.DELETE_PRODUCT_GRID, { headers: { data } });
...
export const deleteReview = (data: any) =>
  api.delete(url.DELETE_REVIEW, { headers: { data } });
...
export const updateEmployee = (data: any) =>
  api.update(url.UPDATE_EMPLOYEE, data);
export const deleteEmployee = (data: any) =>
  api.delete(url.DELETE_EMPLOYEE, { headers: { data } });

// Holidays
export const getHolidays = () => api.get(url.GET_HOLIDAYS, null);
export const addHolidays = (data: any) => api.create(url.ADD_HOLIDAYS, data);
export const updateHolidays = (data: any) =>
  api.update(url.UPDATE_HOLIDAYS, data);
export const deleteHolidays = (data: any) =>
  api.delete(url.DELETE_HOLIDAYS, { headers: { data } });

// Leaves Manage

// Leave Manage (Employee)
export const getLeaveManageEmployee = () =>
  api.get(url.GET_LEAVE_MANAGE_EMPLOYEE, null);

// Leave Manage (HR)
export const getLeaveManageHR = () => api.get(url.GET_LEAVE_MANAGE_HR, null);
export const addLeaveManageHR = (data: any) =>
  api.create(url.ADD_LEAVE_MANAGE_HR, data);
export const updateLeaveManageHR = (data: any) =>
  api.update(url.UPDATE_LEAVE_MANAGE_HR, data);
export const deleteLeaveManageHR = (data: any) =>
  api.delete(url.DELETE_LEAVE_MANAGE_HR, { headers: { data } });
...
export const addDepartments = (data: any) =>
  api.create(url.ADD_DEPARTMENTS, data);
export const updateDepartments = (data: any) =>
  api.update(url.UPDATE_DEPARTMENTS, data);
export const deleteDepartments = (data: any) =>
  api.delete(url.DELETE_DEPARTMENTS, { headers: { data } });
...
export const updateEstimates = (data: any) =>
  api.update(url.UPDATE_ESTIMATES, data);
export const deleteEstimates = (data: any) =>
  api.delete(url.DELETE_ESTIMATES, { headers: { data } });
...
export const updateExpenses = (data: any) =>
  api.update(url.UPDATE_EXPENSES, data);
export const deleteExpenses = (data: any) =>
  api.delete(url.DELETE_EXPENSES, { headers: { data } });

// Payroll
// Employee Salary
export const getEmployeeSalary = () => api.get(url.GET_EMPLOYEE_SALARY, null);
export const addEmployeeSalary = (data: any) =>
  api.create(url.ADD_EMPLOYEE_SALARY, data);
export const updateEmployeeSalary = (data: any) =>
  api.update(url.UPDATE_EMPLOYEE_SALARY, data);
export const deleteEmployeeSalary = (data: any) =>
  api.delete(url.DELETE_EMPLOYEE_SALARY, { headers: { data } });
...
export const deleteNotes = (data: any) =>
  api.delete(url.DELETE_NOTES, { headers: { data } });
...
export const addSocialEvent = (data: any) =>
  api.create(url.ADD_SOCIAL_EVENTS, data);
export const updateSocialEvent = (data: any) =>
  api.update(url.UPDATE_SOCIAL_EVENTS, data);
export const deleteSocialEvent = (data: any) =>
  api.delete(url.DELETE_SOCIAL_EVENTS, { headers: { data } });
...
export const updateUserList = (data: any) =>
  api.update(url.UPDATE_USER_LIST, data);
export const deleteUserList = (user: any) =>
  api.delete(url.DELETE_USER_LIST, { headers: { user } });
...
export const updateUserGrid = (data: any) =>
  api.update(url.UPDATE_USER_GRID, data);
export const deleteUserGrid = (user: any) =>
  api.delete(url.DELETE_USER_GRID, { headers: { user } });
